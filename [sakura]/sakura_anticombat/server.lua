local webhook = "https://discord.com/api/webhooks/919819888531501107/zOtTNMdhuH4hNq4wxwhAJCkwWGyhqje100HaH1ue5arIY2F8fn2ysnA-yhoXlv0RuqMO"
...
AddEventHandler("playerDropped", function(reason)
    ...
    TriggerClientEvent("ot-acl", -1, id, crds, identifier, reason, name)
