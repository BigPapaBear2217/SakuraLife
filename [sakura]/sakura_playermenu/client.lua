...
RegisterNUICallback('Kofferraum', function(data, cb)
	...
	if distance ~= -1 and distance <= 3.0 then                    
        TriggerEvent("ot-notify:notify", 1, "Support ID", "Support-ID vom Spieler: " .. GetPlayerServerId(player), 2500)

	else
		TriggerEvent("ot-notify:notify", 3, "", "Keine Spieler in der Nähe!", 3000)
