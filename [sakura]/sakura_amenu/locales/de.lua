...
Locales['de'] = {
    --RageUI
    ['menu_aduty'] = 'Admin Duty',
    ['menu_godmode'] = 'GodMode',
    ['menu_vanish'] = 'Vanish',
    ['menu_nametags'] = 'Nametags',
    ['menu_coords'] = 'Koordinaten',
    ['menu_noclip'] = 'NoClip Key',
    --['menu_noclip2'] = 'NoClip Speed',
    ['menu_noclip3'] = 'NoClip',
    ['menu_no_perms'] = 'Benötigte Rechte: %s'
}