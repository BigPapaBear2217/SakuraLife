Locales['de'] = {
    ...
    ['press_to_rob'] = 'drücke ~INPUT_CONTEXT~ ~o~zum ausrauben~s~ ~y~%s~s~',
    ...
    ['rob_in_prog'] = '~r~Raub im gange bei: ~y~%s~s~',
    ...
    ['robbery_cancelled_at'] = '~r~Raub abgebrochen bei: ~y~%s~s~',
    ['min_police'] = 'es müssen mindestens ~y~%s polizisten~s~ im Dienst sein um den Raub zu starten.',
