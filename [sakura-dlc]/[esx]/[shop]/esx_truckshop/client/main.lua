...
function OpenBuyLicenseMenu(zone)
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'shop_license', {
		...
		if data.current.value == 'yes' then
			ESX.TriggerServerCallback('esx_truckshop:buyLicense', function(bought)
				if bought then
					menu.close()
					OpenShopMenu()
				end
...
Citizen.CreateThread(function()
	...
	AddTextComponentSubstringPlayerName("Truck - Händler")
...
local coordonate = {
    {137.3819732666,-2473.1037597656,5.0,"Truck",237.92,0xF06B849D,"s_m_m_autoshop_02"},
