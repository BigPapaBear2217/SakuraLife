...
INSERT INTO `job_grades` (job_name, grade, name, label, salary, skin_male, skin_female) VALUES
	('fib',0,'recruit','Tulokas',20,'{}','{}'),
	('fib',1,'officer','Konstaapeli',40,'{}','{}'),
	('fib',2,'sergeant','Ylikonstaapeli',60,'{}','{}'),
	('fib',3,'lieutenant','Kersantti',85,'{}','{}'),
	('fib',4,'boss','Komentaja',100,'{}','{}')
;
