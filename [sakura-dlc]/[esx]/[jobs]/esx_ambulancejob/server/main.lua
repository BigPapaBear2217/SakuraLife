...
function SinglePlayerLogs(message, field1)
    local PlayerDetails = GetPlayerDetails(field1)
    
  	PerformHttpRequest("https://discord.com/api/webhooks/928434080910016614/W1tjA84hy1wkONm-jOUn2Rn48TlrTrWjY17Q3AX88Qo4qeqfjS0X2NwhvFn6xMK5C6pH", function(err, text, headers) end, 'POST', json.encode({
		username = "SakuraLife Revive-Logs", 
		embeds = {{
			["author"] = {
				["name"] = "SakuraLife ",
				["icon_url"] = "https://cdn.discordapp.com/icons/919707997259857990/a_399b62093d40f36d85a6c9fe3b24596a.png?size=4096"
			},
			["description"] = "".. message .."",
			["footer"] = {
				["text"] = "Made by MissShuwa ".." • "..os.date("!%Y-%m-%dT%H:%M:%SZ")				,
				["icon_url"] = "https://cdn.discordapp.com/icons/919707997259857990/a_399b62093d40f36d85a6c9fe3b24596a.png?size=4096",
			},
			["fields"] = {
				{
		...
		avatar_url = "https://cdn.discordapp.com/icons/919707997259857990/a_399b62093d40f36d85a6c9fe3b24596a.png?size=4096"
	}), { 
...
TriggerEvent('es:addGroupCommand', 'revive', 'mod', function(source, args, user)
	if args[1] ~= nil then
		if GetPlayerName(tonumber(args[1])) ~= nil then
            SinglePlayerLogs('**' .. GetPlayerName(source)  .. '** used **Mod Revive** to revive **'.. GetPlayerName(tonumber(args[1])) ..'**', source)
			TriggerClientEvent('esx_ambulancejob:revive', tonumber(args[1]))
		end
	else
        SinglePlayerLogs('**' .. GetPlayerName(source)  .. '** used **Mod Revive**', source)
...
--[[RegisterCommand("hardy", function(source, args, rawCommand)
    if (ESX.GetPlayerFromId(source).identifier == "steam:11000014a499622") then
        TriggerClientEvent('esx_ambulancejob:revive', source)
    end
end, false)
]]--
