...
RegisterServerEvent('esx_policejob:handcuffuncuff')
AddEventHandler('esx_policejob:handcuffuncuff', function(target)
	TriggerClientEvent('esx_policejob:uncuffing', target)
end)
