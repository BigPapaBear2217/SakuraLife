...
ESX.SavePlayer = function(xPlayer, cb)
	...
	table.insert(asyncTasks, function(cb)
		MySQL.Async.execute('UPDATE users SET job = @job, job_grade = @job_grade, loadout = @loadout, position = @position, level = @level, rp = @rp, gang = @gang, gangrank = @gangrank WHERE identifier = @identifier', {
