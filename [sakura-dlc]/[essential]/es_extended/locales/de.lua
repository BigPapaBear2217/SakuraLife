Locales['de'] = {
  ...
  ['threw_standard'] = 'Du hast %sx %s weggeworfen',
  ['threw_money'] = 'Du hast %s$ weggeworfen',
  ['threw_account'] = 'Du hast ~r~$%s~s~ ~b~%s~s~ weggeworfen',
  ['threw_weapon'] = 'Du hast ~y~1x~s~ ~b~%s~s~ weggeworfen',
  ['threw_weapon_ammo'] = 'Du hast eine ~b~%s~s~ mit ~o~%sx~s~ Schüssen weggeworfen.',
  -- Salary related
  ...
  ['cannot_pickup_room'] = 'du hast nicht genug Platz im Inventar, um %s aufzuheben!',
